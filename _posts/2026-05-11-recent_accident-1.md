...
- [ Windows Central — Microsoft](https://www.windowscentral.com/microsoft/microsoft-copilots-own-default-configuration-exposed-users-to-the-first-ever-zero-click-ai-attack-but-there-was-no-data-breach)
